create PROCEDURE [dbo].[OPL_DQReport_DataUpdate_EPS] 

AS

BEGIN

SELECT DISTINCT EsaProjectId,Archetype,WorkCategory INTO #DistinctTemp FROM dbo.OPLDQReport_EPS 
...
TRUNCATE TABLE dbo.OPLDQReport_EPS

INSERT INTO dbo.OPLDQReport_EPS (EsaProjectId, Main_Sub_Project_Flag, Archetype, WorkCategory)
