create PROCEDURE [dbo].[OPL_DQReport_DataUpdate] 

AS

BEGIN

SELECT DISTINCT EsaProjectId,Archetype,WorkCategory INTO #DistinctTemp FROM dbo.OPLDQReport 
...
TRUNCATE TABLE dbo.OPLDQReport

INSERT INTO dbo.OPLDQReport (EsaProjectId, Main_Sub_Project_Flag, Archetype, WorkCategory)
