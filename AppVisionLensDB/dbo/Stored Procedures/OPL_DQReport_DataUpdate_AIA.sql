CREATE PROCEDURE [dbo].[OPL_DQReport_DataUpdate_AIA] 

AS

BEGIN

SELECT DISTINCT EsaProjectId,Archetype,WorkCategory INTO #DistinctTemp FROM dbo.OPLDQReport_AIA 
...
TRUNCATE TABLE dbo.OPLDQReport_AIA

INSERT INTO dbo.OPLDQReport_AIA (EsaProjectId, Main_Sub_Project_Flag, Archetype, WorkCategory)
