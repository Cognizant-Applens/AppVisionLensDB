create PROCEDURE [dbo].[OPL_DQReport_DataUpdate_CDB] 

AS

BEGIN

SELECT DISTINCT EsaProjectId,Archetype,WorkCategory INTO #DistinctTemp FROM dbo.OPLDQReport_CDB 
...
TRUNCATE TABLE dbo.OPLDQReport_CDB

INSERT INTO dbo.OPLDQReport_CDB (EsaProjectId, Main_Sub_Project_Flag, Archetype, WorkCategory)
