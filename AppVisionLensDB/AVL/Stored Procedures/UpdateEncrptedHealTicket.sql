...
CREATE PROCEDURE [AVL].[UpdateEncrptedHealTicket]

@TicketEncryptedList AS [AVL].[HealTicketDetailsEncrypt] READONLY
AS 
BEGIN

UPDATE A SET TicketDescription_Encrypt=B.[TicketDescriptionEncrpted]
FROM AVL.DEBT_TRN_HealTicketDetails_Encrypt A 
JOIN @TicketEncryptedList B ON A.Id=B.Id
AND A.HealingTicketID=B.HealingTicketID
