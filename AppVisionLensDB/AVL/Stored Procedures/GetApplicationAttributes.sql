...
CREATE PROCEDURE [AVL].[GetApplicationAttributes](
...
AND AD.IsActive=1 AND BCM.IsHavingSubBusinesss=0 AND C.ESA_AccountID=@EsaAccountID
...
BEGIN CATCH  
		...
		--INSERT Error    
		EXEC AVL_InsertError '[AVL].[GetApplicationAttributes]',@ErrorMessage,@UserId,@AccountID
