...
CREATE   PROCEDURE [AVL].[DownloadEffort_GetSearchTickets]    
...
BEGIN       
 ...
 SELECT        
  ...
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.ActualEndDateTime)) AS ActualEndDateTime, 
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.ActualStartDateTime)) AS ActualStartDateTime, 
  TD.ActualWorkSize,                           
  TD.ApplicationID,      
  TD.ApprovedBy,       
  TD.AssignedTo,      
  ...
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.CancelledDateTime)) AS CancelledDateTime, 
  TD.Category,      
  TD.CauseCodeMapID,      
  --TD.ClosedDate,    
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.ClosedDate))AS ClosedDate,
  TD.Comments,                           
  --TD.CompletedDateTime,
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.CompletedDateTime))AS CompletedDateTime,
  TD.DARTStatusID,       
  ...
  --TD.OnHoldDateTime,       
  --TD.OpenDateTime,
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.OnHoldDateTime)) AS OnHoldDateTime,
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.OpenDateTime)) AS OpenDateTime,
  TD.OutageDuration,                           
  TD.PlannedEffort,       
  --TD.PlannedEndDate,       
  --TD.PlannedStartDate,  
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.PlannedEndDate)) AS PlannedEndDate,
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.PlannedStartDate)) AS PlannedStartDate,
  TD.PriorityMapID,       
  TD.ProjectID,      
  TD.RCAID,       
  --TD.RejectedDateTime, 
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.RejectedDateTime)) AS RejectedDateTime,
  TD.RelatedTickets,       
  TD.ReleaseTypeMapID,       
  --TD.ReopenDateTime,
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.ReopenDateTime)) AS ReopenDateTime,
  TD.RepeatedIncident,       
  ...
  TD.SeverityMapID,                           
  --TD.StartedDateTime,  
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.StartedDateTime)) AS StartedDateTime,
  TD.TicketCreatedBy,       
  ...
  TD.TicketTypeMapID,      
  --TD.WIPDateTime,   
  DATEADD(HOUR, +5, DATEADD(MINUTE, +30, TD.WIPDateTime)) AS WIPDateTime,
  P.ProjectName                          
 INTO       
  #TicketTemp        
