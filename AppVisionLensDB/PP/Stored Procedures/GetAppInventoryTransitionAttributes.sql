...
CREATE PROCEDURE [PP].[GetAppInventoryTransitionAttributes]
...
BF.AttributeValueName as [BusinessFunction],
 OC.AttributeValueName  as [OperationallyCritical],
	...
	where tra.ApplicationId = @applicationID and isdeleted = 0
...
END TRY
	BEGIN CATCH  
		...
		EXEC AVL_InsertError '[PP].[GetAppInventoryTransitionAttributes]', @ErrorMessage, @UserID, @applicationID 
