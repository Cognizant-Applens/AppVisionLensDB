CREATE TABLE [ML].[CL_InfraBaseDetails] (
    ...
    CONSTRAINT [PK_InfraBaseDetailsID] PRIMARY KEY CLUSTERED ([BaseDetailsID] ASC),
    CONSTRAINT [FK_InfraContLearingID] FOREIGN KEY ([ContLearningID]) REFERENCES [ML].[CL_PRJ_InfraContLearningState] ([ContLearningID]),
    CONSTRAINT [FK_InfraProjectID] FOREIGN KEY ([ProjectID]) REFERENCES [AVL].[MAS_ProjectMaster] ([ProjectID])
);
