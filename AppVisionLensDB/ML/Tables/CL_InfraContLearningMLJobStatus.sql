CREATE TABLE [ML].[CL_InfraContLearningMLJobStatus] (
    ...
    CONSTRAINT [FK_CL_InfraContLearningMLJobStatus_CL_PRJ_InfraContLearningState] FOREIGN KEY ([ContLearningID]) REFERENCES [ML].[CL_PRJ_InfraContLearningState] ([ContLearningID]),
    CONSTRAINT [FK_InfraStatusProjectID] FOREIGN KEY ([ProjectID]) REFERENCES [AVL].[MAS_ProjectMaster] ([ProjectID])
);
