CREATE PROCEDURE [ML].[GetMLPatternTickets]
(
@ProjectID BIGINT 
)
AS
	...
	BEGIN TRY 
		  ...
		  SET NOCOUNT ON;
			...
			SET @CustomerID=(SELECT TOP 1 CustomerID 
				 ...
				 BD.ApplicationName  AS [Application Name],
				 ...
				 LEFT JOIN #TempPatternValidation TPV
						 ...
						 AND BD.ApplicationName = TPV.[Application]
