...
-- [ML].[UpdateTicketDescription] '441778', 10569 ,'10/22/2018','1/21/2019','627384' 
-- =============================================  

CREATE PROCEDURE [ML].[UpdateTicketDescription]
(
...
BEGIN TRAN
	...
	SET @InintialLearnId = (SELECT TOP 1 ID FROM ML.ConfigurationProgress WHERE ProjectID = @ProjectID AND IsDeleted = @IsDeleted ORDER BY ID DESC)
...
BEGIN CATCH  
		...
		ROLLBACK TRAN
		--INSERT Error    
		EXEC AVL_InsertError '[ML].[UpdateTicketDescription]', @ErrorMessage, '',0
