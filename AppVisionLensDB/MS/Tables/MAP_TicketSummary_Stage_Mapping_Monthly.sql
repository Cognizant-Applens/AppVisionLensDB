CREATE TABLE [MS].[MAP_TicketSummary_Stage_Mapping_Monthly] (
    [ID]                  BIGINT          NOT NULL,
    ...
    [flag]                INT             NULL,
    CONSTRAINT [PK_TicketSummary_Stage_Mapping_Monthly] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 70)
);
