...
CREATE PROCEDURE [MS].[Mainspring_InsertTicketBaseMeasureDARTByProject]  
 @lstTicketBaseMeasureData [MS].[Mainspring_TicketBaseMeasureDARTProject_TVP] READONLY,  
 @ProjectID INT,  
 @ReportingPeriod INT,  
 @FrequencyId INT  
...
BEGIN  
 ...
 DELETE RealTable  
 FROM MS.TRN_ProjectStaging_TillDateBaseMeasure_TicketSummary   RealTable  
 ...
 RealTable.ReportPeriodID=@ReportingPeriod  
  ...
  INSERT INTO MS.TRN_ProjectStaging_TillDateBaseMeasure_TicketSummary(ProjectStageID,  
