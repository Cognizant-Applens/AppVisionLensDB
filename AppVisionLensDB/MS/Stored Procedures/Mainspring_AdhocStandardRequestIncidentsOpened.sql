...
-- Description:Total Number of Adhoc and Standard service Request
--Consider all the Standard+Adhoc alone opened in that reporting month irrespective of status .
--Ignore - Cancelled or rejected 
-- =============================================
--EXEC [MS].[Mainspring_AdhocStandardRequestIncidentsOpened] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_AdhocStandardRequestIncidentsOpened] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_AdhocStandardRequestIncidentsOpened]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=435,@Technology=NULL
--EXEC [MS].[Mainspring_AdhocStandardRequestIncidentsOpened]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=435,@Technology='High Level'


CREATE PROCEDURE [MS].[Mainspring_AdhocStandardRequestIncidentsOpened]
	@ProjectID BIGINT,
	@ServiceID INT ,
...
BEGIN
	...
	--SELECT COUNT(*) AS AdhocStandardRequestIncidentsOpened 
	...
	--WHERE TM.OpenDateTime >= @StartDate AND TM.OpenDateTime < @EndDate
	--AND TM.DARTStatusID NOT IN(5,7,13)
	----AND TM.PriorityID IS NOT NULL AND TM.ApplicationID IS NOT NULL
