...
-- Description:Total Number  of Proactive problems tickets with KEDB solutions 
--Consider the no. of problem tickets that are opened  with in the reporting period
-- irrespective of status (ignore cancelled) and with KEDB added
-- =============================================

--EXEC [MS].[Mainspring_IncidentsOpenedProactiveSourcewithKEDBUpdated] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsOpenedProactiveSourcewithKEDBUpdated] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsOpenedProactiveSourcewithKEDBUpdated]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=435,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsOpenedProactiveSourcewithKEDBUpdated]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=435,@Technology='High Level'


CREATE PROCEDURE [MS].[Mainspring_IncidentsOpenedProactiveSourcewithKEDBUpdated]
	@ProjectID BIGINT,
	@ServiceID INT,
...
BEGIN
	...
	AND TM.DARTStatusID != 5
	AND TM.KEDBUpdatedMapID=2
...
--SELECT KEDBUpdatedMapID FROM AppVisionLensOffline.RPT.TK_TRN_TicketDetail(NOLOCK)
--SELECT * FROM AVL.TK_MAS_KEDBUpdated
