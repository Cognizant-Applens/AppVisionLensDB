...
-- Description:Total number of Known and Unknown incidents
--Consider all the Known and unknown incidents  alone opened in that 
--reporting month irrespective of status .
--Ignore - Cancelled or rejected 
-- =============================================
--EXEC [MS].[Mainspring_KnownUnknownIncidentsOpened] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_KnownUnknownIncidentsOpened]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_KnownUnknownIncidentsOpened]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=435,@Technology=NULL
--EXEC [MS].[Mainspring_KnownUnknownIncidentsOpened] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=435,@Technology='High Level'

CREATE PROCEDURE [MS].[Mainspring_KnownUnknownIncidentsOpened]
	@ProjectID BIGINT,
	@ServiceID INT ,
...
BEGIN
	...
	SELECT COUNT(*) AS KnownUnknownIncidentsOpened 
