...
-- Description: Number of closed unknown incidents) for the reporting period  
--Reporting period- Closed date   
--Pull the No. closed tickets from ticket master with status as closed for the reporting period   
--refer rpt.Ticket master  
-- =============================================  
--EXEC [MS].[Mainspring_IncidentsClosedByServiceSCPT] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsClosedByServiceSCPT] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsClosedByServiceSCPT]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=435,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsClosedByServiceSCPT]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=435,@Technology='High Level'


CREATE PROCEDURE [MS].[Mainspring_IncidentsClosedByServiceSCPT]  
 @ProjectID BIGINT,  
 @ServiceID INT,  
 @StartDate VARCHAR(50),  
 @EndDate VARCHAR(50),  
 @Priority VARCHAR(100)=NULL,  
 @SupportCategory VARCHAR(100)=NULL,  
...
BEGIN  
 ...
 SELECT COUNT(*) AS IncidentsClosed FROM AppVisionLensOffline.RPT.TK_TRN_TicketDetail(NOLOCK) TM  
