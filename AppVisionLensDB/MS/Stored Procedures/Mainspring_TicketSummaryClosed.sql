...
-- Description:	No. of  tickets closed in the  
--reporting month with status as closed
-- =============================================

--EXEC [MS].[Mainspring_TicketSummaryClosed] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=NULL
--EXEC [MS].[Mainspring_TicketSummaryClosed] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=2,@SupportCategory=NULL
--EXEC [MS].[Mainspring_TicketSummaryClosed] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=433
--EXEC [MS].[Mainspring_TicketSummaryClosed] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=1,@SupportCategory=433
CREATE PROCEDURE [MS].[Mainspring_TicketSummaryClosed]
	@ProjectID BIGINT,
	@ServiceID INT,
...
BEGIN
	...
	SELECT COUNT(*) AS TicketSummaryClosed FROM AppVisionLensOffline.RPT.TK_TRN_TicketDetail(NOLOCK) TM
	...
	AND TM.Closeddate >= @StartDate 
	AND TM.Closeddate < @EndDate
