...
CREATE PROCEDURE [MS].[Mainspring_InsertBaseMeasureDARTByProject]  
 @lstBaseMeasureData MS.[Mainspring_BaseMeasureDARTProject_TVP] READONLY,  
 @ProjectID INT,  
 @ReportingPeriod INT,  
 @FrequencyId INT  
...
BEGIN  
 ...
 DELETE RealTable  
 FROM MS.TRN_ProjectStaging_TillDateBaseMeasure  RealTable  
 ...
 RealTable.ReportPeriodID=@ReportingPeriod  
  ...
  INSERT INTO MS.TRN_ProjectStaging_TillDateBaseMeasure (ProjectStageID,  
