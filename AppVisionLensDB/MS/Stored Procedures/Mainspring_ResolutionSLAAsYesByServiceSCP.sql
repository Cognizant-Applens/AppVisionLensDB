...
--EXEC [MS].[Mainspring_ResolutionSLAAsYesByServiceSCP] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_ResolutionSLAAsYesByServiceSCP] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=2,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_ResolutionSLAAsYesByServiceSCP] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=434,@Technology=NULL
--EXEC [MS].[Mainspring_ResolutionSLAAsYesByServiceSCP] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=1,@SupportCategory=434,@Technology='High Level'
CREATE PROCEDURE [MS].[Mainspring_ResolutionSLAAsYesByServiceSCP]
	@ProjectID BIGINT,
	@ServiceID INT,
