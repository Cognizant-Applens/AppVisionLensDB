...
-- Description:	<Execute_GetMetricsValueByProjectIdWithSCPT>
-- =============================================
CREATE PROCEDURE [MS].[Execute_GetMetricsValueByProjectIdWithSCPT] 
    @ProjectID BIGINT,
	@ServiceID INT,
...
BEGIN TRAN
 ...
 COMMIT TRAN
  ...
  DECLARE @ErrorMessage VARCHAR(MAX);
	...
	ROLLBACK TRAN
		--INSERT Error    
		EXEC AVL_InsertError '[MS].[Execute_GetMetricsValueByProjectIdWithSCPT]', @ErrorMessage, @ProjectID
  END CATCH   
