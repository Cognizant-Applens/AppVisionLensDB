...
-- Description:Total number of incidents received in the reporting period
--Consider the no. of incidents(Known+unknown)reported in 
--the peporting period irrespective of status ignore cancelled
-- =============================================
--EXEC [MS].[Mainspring_IncidentsReceivedProactiveSource] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsReceivedProactiveSource] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=NULL,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsReceivedProactiveSource]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=NULL,@SupportCategory=435,@Technology=NULL
--EXEC [MS].[Mainspring_IncidentsReceivedProactiveSource]  @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-22',@Priority=1,@SupportCategory=435,@Technology='High Level'


CREATE PROCEDURE [MS].[Mainspring_IncidentsReceivedProactiveSource]
	@ProjectID BIGINT,
	@ServiceID INT,
...
BEGIN
	...
	SELECT COUNT(*) AS Mainspring_IncidentsReceivedProactiveSource 
