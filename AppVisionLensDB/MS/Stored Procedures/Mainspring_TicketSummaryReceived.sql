...
-- Description:No. of tickets that has been opened in the 
--reporting period and status not in cancelled or rejected
-- =============================================

--EXEC [MS].[Mainspring_TicketSummaryReceived] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=NULL
--EXEC [MS].[Mainspring_TicketSummaryReceived] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=1,@SupportCategory=NULL
--EXEC [MS].[Mainspring_TicketSummaryReceived] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=NULL,@SupportCategory=433
--EXEC [MS].[Mainspring_TicketSummaryReceived] @ProjectID=40635,@ServiceID=4,@StartDate='2018-06-01',@EndDate='2018-06-21',@Priority=1,@SupportCategory=433
CREATE PROCEDURE [MS].[Mainspring_TicketSummaryReceived]
	@ProjectID BIGINT,
	@ServiceID INT,
...
BEGIN
	...
	INNER JOIN #PRIORITY WITH(NOLOCK)  ON TM.PriorityMapID =ISNULL(P.PriorityID,TM.PriorityMapID) 
