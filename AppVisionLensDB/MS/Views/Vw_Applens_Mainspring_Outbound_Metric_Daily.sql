CREATE VIEW [MS].[Vw_Applens_Mainspring_Outbound_Metric_Daily]
AS
  ...
  ON J.JobId = OB.JobId AND J.IsOutbound = 1 AND J.IsDaily = 0 AND J.JobStatusId = 2
  ...
  JOIN MS.EformViewDetails(NOLOCK) EF
