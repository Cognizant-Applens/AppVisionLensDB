...
-- Create date: <>  
-- Description: <>  
-- Execution  : [AC].[SaveCertificationDetailsOnPremJob]  '',''  
-- =============================================  
Create PROCEDURE [AC].[SaveCertificationDetailsOnPremJob]    
(    
...
BEGIN TRY
  ...
  set @AccountIds =(select CustomerID from avl.MAS_ProjectMaster (NOLOCK) where EsaProjectID=@EsaProjectId)
   ...
   set @MONTH=@CertificationMonth --(MONTH(@CertificationMonth + ' 1 2021'))  
